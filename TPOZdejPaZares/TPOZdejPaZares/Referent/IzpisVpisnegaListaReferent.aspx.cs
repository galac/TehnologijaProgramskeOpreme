...
{
    public partial class IzpisVpisnegaListaReferent : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "aaa", "<script type='text/javascript'>alert('Ta uporabnik ni bil še nikoli vpisan v katerikoli predmet.')\nwindow.location = 'UvodVIzpisVpisnegaLista.aspx'</script>", false);
                    return;
                }
