<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RezultatiPisnegaDelaIzpita.aspx.cs" Inherits="TPOZdejPaZares.Ucitelj.RezultatiPisnegaDelaIzpita" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            ...
            <asp:CheckBox runat="server" ID="anonimniIzpisCB" Checked="true" Text="Izpis brez imena in priimka" Visible="false"/>
