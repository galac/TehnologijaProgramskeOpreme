<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VnosRezultatovPisnegaDelaIzpitaInKoncnihOcenRef.aspx.cs" Inherits="TPOZdejPaZares.Referent.VnosRezultatovPisnegaDelaIzpitaInKoncnihOcenRef" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GV_seznamStudentov_O" runat="server" AutoGenerateColumns="false" CssClass="table table-striped" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Polaganj">
                        <ItemTemplate>
