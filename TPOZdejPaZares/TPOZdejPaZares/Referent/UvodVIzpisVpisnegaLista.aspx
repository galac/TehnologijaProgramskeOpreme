<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UvodVIzpisVpisnegaLista.aspx.cs" Inherits="TPOZdejPaZares.Referent.UvodVIzpisVpisnegaLista" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <br />
    <h3>Izpis vpisnega lista</h3>
    <br /><br />
