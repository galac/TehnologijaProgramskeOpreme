        ...
        <ContentTemplate>    
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <asp:DropDownList runat="server" ID="LetnikDDL" OnSelectedIndexChanged="StudijskiProgramDDL_SelectedIndexChanged" 
                        AutoPostBack="true" class="btn btn-primary dropdown-toggle" Style="margin-bottom:1em;" Visible="false"></asp:DropDownList>
                    <asp:DropDownList runat="server" ID="SestavniDelPredDDL" OnSelectedIndexChanged="StudijskiProgramDDL_SelectedIndexChanged" 
                        AutoPostBack="true" class="btn btn-primary dropdown-toggle" Style="margin-bottom:1em;" Visible="false"></asp:DropDownList>
                    <br />
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4" id="dodajPredmet" style="display:none" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <br />
                        <asp:Label runat="server">Razvrstitev (obvezni/strokovni izbirni/prosti izbirni/modul)</asp:Label><br />
                        <asp:DropDownList runat="server" ID="SestavniDelPredDDL_Dodaj" OnSelectedIndexChanged="SestavniDelPredDDL_Dodaj_SelectedIndexChanged" 
                            CssClass="btn btn-sm btn-default dropdown-toggle" AutoPostBack="true"></asp:DropDownList>
                        <br />
                        <asp:Label runat="server" ID="LetnikLabel" Visible="false">Letnik:</asp:Label><br />
                        <asp:DropDownList runat="server" ID="LetnikDDL_Dodaj" Visible="false" CssClass="btn btn-sm btn-default dropdown-toggle"></asp:DropDownList>
