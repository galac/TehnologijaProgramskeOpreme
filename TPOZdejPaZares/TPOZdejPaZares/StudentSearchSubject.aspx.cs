...
{
    public partial class StudentSearchSubject : System.Web.UI.Page
    {
        ...
        protected void DDL_SubjectList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var izvedbePredmeta = (from i in db.IzvedbaPredmeta
                                   ...
                                   select new
                                   {
                                       ...
                                       x.SestavniDelPred,
                                       x.KreditneTocke,
                                       Izvajalci = String.Format("{0}. {1}, {2}. {3}, {4}. {5}", x.Prof1I[0], x.Prof1P, x.Prof2I[0], x.Prof2P, x.Prof3I[0], x.Prof3P),
                                       x.idIzvedbaPredmeta
                                   });
        ...
        {
            _Default.exportToPdf(GetDataTable(GV_students), Response, L_header31.Text, new int[] { 7, 25, 15, 30});
        }
        ...
        {
            Session["vpisnaStudent00"] = GV_students.SelectedRow.Cells[2].Text;
            Response.Redirect("~/StudentDetailsPROF.aspx");
        }
    }
}