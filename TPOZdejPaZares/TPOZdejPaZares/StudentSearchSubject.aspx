<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentSearchSubject.aspx.cs" Inherits="TPOZdejPaZares.StudentSearchSubject" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            ...
            <asp:Button ID="buttonPdf" runat="server" Text="Shrani kot PDF" type="submit" OnClick="buttonExportToPdf_click" CssClass="btn btn-primary" Visible="true" />
            <asp:Button ID="buttonCsv" runat="server" Text="Shrani kot CSV" type="submit" OnClick="buttonExportToCsv_click" CssClass="btn btn-primary" Visible="true" />
        </ContentTemplate>
        <Triggers>
