...
{
    public partial class KartotecniListStudent : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "aaa", "<script type='text/javascript'>alert('Uporabnik še nima nobenega vpisa.')\nwindow.location = 'ZajemVpisnegaListaStudent.aspx'</script>", false);
                return;
            }
