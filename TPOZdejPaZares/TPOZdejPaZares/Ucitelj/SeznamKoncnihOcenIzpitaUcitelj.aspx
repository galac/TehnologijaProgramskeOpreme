<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SeznamKoncnihOcenIzpitaUcitelj.aspx.cs" Inherits="TPOZdejPaZares.Ucitelj.SeznamKoncnihOcenIzpitaUcitelj" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GV_prijavljeni" runat="server" AutoGenerateColumns="false" class="table table-striped"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Ocena" HeaderText="Končna ocena" />
