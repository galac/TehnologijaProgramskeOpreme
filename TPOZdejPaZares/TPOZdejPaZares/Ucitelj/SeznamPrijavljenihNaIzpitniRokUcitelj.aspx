<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SeznamPrijavljenihNaIzpitniRokUcitelj.aspx.cs" Inherits="TPOZdejPaZares.Ucitelj.SeznamPrijavljenihNaIzpitniRokUcitelj" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GV_izpitni_roki" runat="server" AutoGenerateColumns="false" class="table table-striped" 
                ...
                <Columns>
                    ...
                    <asp:CommandField SelectText="prijavljeni" ShowSelectButton="True" />
                </Columns>
            </asp:GridView>
            ...
            <asp:GridView ID="GV_prijavljeni" runat="server" AutoGenerateColumns="false" class="table table-striped"
                OnSelectedIndexChanged="GV_prijavljeni_SelectedIndexChanged">
                <Columns>
                    <asp:BoundField DataField="Zaporedna" HeaderText="Št." />                    
